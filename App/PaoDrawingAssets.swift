...
//  Pao
//
//  Created by Sergio Soto on 10/15/17.
...
public class PaoDrawingAssets : NSObject {
    ...
    public dynamic class func drawPaoEgg(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 250, height: 250), resizing: ResizingBehavior = .aspectFit, time: CGFloat = 1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
