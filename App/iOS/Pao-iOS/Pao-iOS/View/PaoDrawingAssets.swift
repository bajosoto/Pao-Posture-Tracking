...
public class PaoDrawingAssets : NSObject {
    ...
    @objc public dynamic class func drawPaoMovingGoal(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 180, height: 180), resizing: ResizingBehavior = .aspectFit, postureGoalPercentage: CGFloat = 0.65) {
        ...
        //// WalkingPerson
        context.saveGState()
        context.translateBy(x: 67.25, y: 67.15)
        context.scaleBy(x: 0.7, y: 0.7)



        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalIn: CGRect(x: 15.5, y: -14, width: 27, height: 26))
        paoTextWhite.setFill()
        ovalPath.fill()
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 1.32, y: 43.53))
        bezierPath.addCurve(to: CGPoint(x: 1.51, y: 43.24), controlPoint1: CGPoint(x: 1.35, y: 43.47), controlPoint2: CGPoint(x: 1.41, y: 43.37))
        bezierPath.addCurve(to: CGPoint(x: 2.02, y: 42.45), controlPoint1: CGPoint(x: 1.65, y: 43.01), controlPoint2: CGPoint(x: 1.83, y: 42.75))
        bezierPath.addCurve(to: CGPoint(x: 3.87, y: 39.67), controlPoint1: CGPoint(x: 2.58, y: 41.61), controlPoint2: CGPoint(x: 3.2, y: 40.68))
        bezierPath.addCurve(to: CGPoint(x: 9.72, y: 31.23), controlPoint1: CGPoint(x: 5.8, y: 36.8), controlPoint2: CGPoint(x: 7.79, y: 33.92))
        bezierPath.addCurve(to: CGPoint(x: 11.24, y: 29.13), controlPoint1: CGPoint(x: 10.23, y: 30.51), controlPoint2: CGPoint(x: 10.74, y: 29.81))
        bezierPath.addCurve(to: CGPoint(x: 21.29, y: 17.72), controlPoint1: CGPoint(x: 15.55, y: 23.25), controlPoint2: CGPoint(x: 18.63, y: 19.57))
        bezierPath.addCurve(to: CGPoint(x: 24.58, y: 15.96), controlPoint1: CGPoint(x: 22.33, y: 16.99), controlPoint2: CGPoint(x: 23.43, y: 16.41))
        bezierPath.addCurve(to: CGPoint(x: 36.91, y: 16.08), controlPoint1: CGPoint(x: 28.83, y: 14.29), controlPoint2: CGPoint(x: 33.03, y: 14.63))
        bezierPath.addCurve(to: CGPoint(x: 39.78, y: 17.43), controlPoint1: CGPoint(x: 38.12, y: 16.53), controlPoint2: CGPoint(x: 39.09, y: 17.01))
        bezierPath.addLine(to: CGPoint(x: 40.11, y: 17.63))
        bezierPath.addLine(to: CGPoint(x: 40.42, y: 17.86))
        bezierPath.addLine(to: CGPoint(x: 61.74, y: 33.7))
        bezierPath.addCurve(to: CGPoint(x: 63.43, y: 45.03), controlPoint1: CGPoint(x: 65.31, y: 36.36), controlPoint2: CGPoint(x: 66.07, y: 41.43))
        bezierPath.addCurve(to: CGPoint(x: 52.19, y: 46.73), controlPoint1: CGPoint(x: 60.8, y: 48.62), controlPoint2: CGPoint(x: 55.76, y: 49.39))
        bezierPath.addLine(to: CGPoint(x: 30.87, y: 30.89))
        bezierPath.addLine(to: CGPoint(x: 35.65, y: 24.38))
        bezierPath.addLine(to: CGPoint(x: 31.51, y: 31.32))
        bezierPath.addCurve(to: CGPoint(x: 31.66, y: 31.41), controlPoint1: CGPoint(x: 31.61, y: 31.38), controlPoint2: CGPoint(x: 31.66, y: 31.41))
        bezierPath.addCurve(to: CGPoint(x: 31.33, y: 31.27), controlPoint1: CGPoint(x: 31.58, y: 31.37), controlPoint2: CGPoint(x: 31.46, y: 31.32))
        bezierPath.addCurve(to: CGPoint(x: 30.52, y: 31.07), controlPoint1: CGPoint(x: 31.04, y: 31.16), controlPoint2: CGPoint(x: 30.75, y: 31.09))
        bezierPath.addCurve(to: CGPoint(x: 30.39, y: 31.05), controlPoint1: CGPoint(x: 30.4, y: 31.06), controlPoint2: CGPoint(x: 30.37, y: 31.06))
        bezierPath.addCurve(to: CGPoint(x: 30.44, y: 31.03), controlPoint1: CGPoint(x: 30.42, y: 31.04), controlPoint2: CGPoint(x: 30.43, y: 31.03))
        bezierPath.addCurve(to: CGPoint(x: 30.46, y: 31.03), controlPoint1: CGPoint(x: 30.5, y: 30.99), controlPoint2: CGPoint(x: 30.5, y: 30.99))
        bezierPath.addCurve(to: CGPoint(x: 30.01, y: 31.46), controlPoint1: CGPoint(x: 30.34, y: 31.13), controlPoint2: CGPoint(x: 30.19, y: 31.28))
        bezierPath.addCurve(to: CGPoint(x: 28.44, y: 33.23), controlPoint1: CGPoint(x: 29.58, y: 31.9), controlPoint2: CGPoint(x: 29.05, y: 32.5))
        bezierPath.addCurve(to: CGPoint(x: 24.17, y: 38.75), controlPoint1: CGPoint(x: 27.24, y: 34.66), controlPoint2: CGPoint(x: 25.79, y: 36.54))
        bezierPath.addCurve(to: CGPoint(x: 22.76, y: 40.7), controlPoint1: CGPoint(x: 23.71, y: 39.38), controlPoint2: CGPoint(x: 23.24, y: 40.03))
        bezierPath.addCurve(to: CGPoint(x: 17.18, y: 48.76), controlPoint1: CGPoint(x: 20.93, y: 43.26), controlPoint2: CGPoint(x: 19.03, y: 46))
        bezierPath.addCurve(to: CGPoint(x: 15.41, y: 51.42), controlPoint1: CGPoint(x: 16.53, y: 49.72), controlPoint2: CGPoint(x: 15.94, y: 50.61))
        bezierPath.addCurve(to: CGPoint(x: 14.92, y: 52.15), controlPoint1: CGPoint(x: 15.23, y: 51.69), controlPoint2: CGPoint(x: 15.06, y: 51.94))
        bezierPath.addCurve(to: CGPoint(x: 14.76, y: 52.4), controlPoint1: CGPoint(x: 14.84, y: 52.28), controlPoint2: CGPoint(x: 14.79, y: 52.36))
        bezierPath.addCurve(to: CGPoint(x: 3.63, y: 54.74), controlPoint1: CGPoint(x: 12.33, y: 56.14), controlPoint2: CGPoint(x: 7.35, y: 57.19))
        bezierPath.addCurve(to: CGPoint(x: 1.32, y: 43.53), controlPoint1: CGPoint(x: -0.08, y: 52.29), controlPoint2: CGPoint(x: -1.12, y: 47.27))
        bezierPath.close()
        paoTextWhite.setFill()
        bezierPath.fill()
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 22.93, y: 69.91))
        bezier2Path.addCurve(to: CGPoint(x: 21.25, y: 25.73), controlPoint1: CGPoint(x: 20.73, y: 43.29), controlPoint2: CGPoint(x: 20.35, y: 30.59))
        bezier2Path.addCurve(to: CGPoint(x: 22.8, y: 21.43), controlPoint1: CGPoint(x: 21.53, y: 24.24), controlPoint2: CGPoint(x: 21.95, y: 22.89))
        bezier2Path.addCurve(to: CGPoint(x: 34.34, y: 15.67), controlPoint1: CGPoint(x: 24.95, y: 17.71), controlPoint2: CGPoint(x: 29.03, y: 14.97))
        bezier2Path.addCurve(to: CGPoint(x: 35.7, y: 15.93), controlPoint1: CGPoint(x: 35.05, y: 15.78), controlPoint2: CGPoint(x: 35.05, y: 15.78))
        bezier2Path.addCurve(to: CGPoint(x: 44.02, y: 30.07), controlPoint1: CGPoint(x: 41.87, y: 17.52), controlPoint2: CGPoint(x: 45.6, y: 23.85))
        bezier2Path.addCurve(to: CGPoint(x: 30, y: 38.45), controlPoint1: CGPoint(x: 42.45, y: 36.28), controlPoint2: CGPoint(x: 36.17, y: 40.04))
        bezier2Path.addCurve(to: CGPoint(x: 31.36, y: 38.71), controlPoint1: CGPoint(x: 30.65, y: 38.6), controlPoint2: CGPoint(x: 30.65, y: 38.6))
        bezier2Path.addCurve(to: CGPoint(x: 42.73, y: 33.12), controlPoint1: CGPoint(x: 36.63, y: 39.41), controlPoint2: CGPoint(x: 40.65, y: 36.71))
        bezier2Path.addCurve(to: CGPoint(x: 43.68, y: 30.96), controlPoint1: CGPoint(x: 43.17, y: 32.35), controlPoint2: CGPoint(x: 43.47, y: 31.64))
        bezier2Path.addCurve(to: CGPoint(x: 43.92, y: 30.01), controlPoint1: CGPoint(x: 43.8, y: 30.59), controlPoint2: CGPoint(x: 43.87, y: 30.28))
        bezier2Path.addCurve(to: CGPoint(x: 43.95, y: 29.81), controlPoint1: CGPoint(x: 43.94, y: 29.92), controlPoint2: CGPoint(x: 43.95, y: 29.85))
        bezier2Path.addCurve(to: CGPoint(x: 43.94, y: 29.94), controlPoint1: CGPoint(x: 43.95, y: 29.83), controlPoint2: CGPoint(x: 43.95, y: 29.87))
        bezier2Path.addCurve(to: CGPoint(x: 43.88, y: 31.11), controlPoint1: CGPoint(x: 43.92, y: 30.21), controlPoint2: CGPoint(x: 43.9, y: 30.6))
        bezier2Path.addCurve(to: CGPoint(x: 43.92, y: 37.12), controlPoint1: CGPoint(x: 43.84, y: 32.51), controlPoint2: CGPoint(x: 43.85, y: 34.5))
        bezier2Path.addCurve(to: CGPoint(x: 45.91, y: 67.98), controlPoint1: CGPoint(x: 44.13, y: 43.9), controlPoint2: CGPoint(x: 44.76, y: 54.02))
        bezier2Path.addCurve(to: CGPoint(x: 35.38, y: 80.52), controlPoint1: CGPoint(x: 46.44, y: 74.37), controlPoint2: CGPoint(x: 41.73, y: 79.99))
        bezier2Path.addCurve(to: CGPoint(x: 22.93, y: 69.91), controlPoint1: CGPoint(x: 29.03, y: 81.06), controlPoint2: CGPoint(x: 23.46, y: 76.3))
        bezier2Path.close()
        paoTextWhite.setFill()
        bezier2Path.fill()
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 39.27, y: 114.02))
        bezier3Path.addCurve(to: CGPoint(x: 32.04, y: 100.57), controlPoint1: CGPoint(x: 36.26, y: 110.09), controlPoint2: CGPoint(x: 33.88, y: 105.57))
        bezier3Path.addCurve(to: CGPoint(x: 27.99, y: 83.27), controlPoint1: CGPoint(x: 29.99, y: 95.01), controlPoint2: CGPoint(x: 28.69, y: 89.14))
        bezier3Path.addCurve(to: CGPoint(x: 27.49, y: 77.44), controlPoint1: CGPoint(x: 27.74, y: 81.19), controlPoint2: CGPoint(x: 27.57, y: 79.23))
        bezier3Path.addCurve(to: CGPoint(x: 27.42, y: 74.75), controlPoint1: CGPoint(x: 27.43, y: 76.28), controlPoint2: CGPoint(x: 27.41, y: 75.37))
        bezier3Path.addCurve(to: CGPoint(x: 27.42, y: 74.68), controlPoint1: CGPoint(x: 27.42, y: 74.7), controlPoint2: CGPoint(x: 27.42, y: 74.7))
        bezier3Path.addCurve(to: CGPoint(x: 34.83, y: 67.37), controlPoint1: CGPoint(x: 27.46, y: 70.6), controlPoint2: CGPoint(x: 30.78, y: 67.32))
        bezier3Path.addCurve(to: CGPoint(x: 42.09, y: 74.84), controlPoint1: CGPoint(x: 38.89, y: 67.41), controlPoint2: CGPoint(x: 42.14, y: 70.76))
        bezier3Path.addCurve(to: CGPoint(x: 42.09, y: 74.83), controlPoint1: CGPoint(x: 42.09, y: 74.82), controlPoint2: CGPoint(x: 42.09, y: 74.82))
        bezier3Path.addCurve(to: CGPoint(x: 42.15, y: 76.72), controlPoint1: CGPoint(x: 42.09, y: 75.19), controlPoint2: CGPoint(x: 42.1, y: 75.83))
        bezier3Path.addCurve(to: CGPoint(x: 42.56, y: 81.49), controlPoint1: CGPoint(x: 42.22, y: 78.16), controlPoint2: CGPoint(x: 42.35, y: 79.77))
        bezier3Path.addCurve(to: CGPoint(x: 45.8, y: 95.42), controlPoint1: CGPoint(x: 43.14, y: 86.29), controlPoint2: CGPoint(x: 44.19, y: 91.05))
        bezier3Path.addCurve(to: CGPoint(x: 50.89, y: 104.99), controlPoint1: CGPoint(x: 47.15, y: 99.1), controlPoint2: CGPoint(x: 48.85, y: 102.32))
        bezier3Path.addCurve(to: CGPoint(x: 49.57, y: 115.36), controlPoint1: CGPoint(x: 53.37, y: 108.22), controlPoint2: CGPoint(x: 52.77, y: 112.86))
        bezier3Path.addCurve(to: CGPoint(x: 39.27, y: 114.02), controlPoint1: CGPoint(x: 46.36, y: 117.85), controlPoint2: CGPoint(x: 41.75, y: 117.25))
        bezier3Path.close()
        paoTextWhite.setFill()
        bezier3Path.fill()
        ...
        bezier6Path.move(to: CGPoint(x: 22.73, y: 78.12))
        bezier6Path.addCurve(to: CGPoint(x: 26.31, y: 75.69), controlPoint1: CGPoint(x: 23.25, y: 77.73), controlPoint2: CGPoint(x: 25.74, y: 75.92))
        bezier6Path.addCurve(to: CGPoint(x: 28.85, y: 94.25), controlPoint1: CGPoint(x: 25.83, y: 85.15), controlPoint2: CGPoint(x: 27.78, y: 91.87))
        bezier6Path.addCurve(to: CGPoint(x: 15.97, y: 108.15), controlPoint1: CGPoint(x: 26.07, y: 97.46), controlPoint2: CGPoint(x: 21.55, y: 101.82))
        bezier6Path.addCurve(to: CGPoint(x: 5.61, y: 108.76), controlPoint1: CGPoint(x: 13.28, y: 111.2), controlPoint2: CGPoint(x: 8.64, y: 111.48))
        bezier6Path.addCurve(to: CGPoint(x: 5, y: 98.33), controlPoint1: CGPoint(x: 2.58, y: 106.05), controlPoint2: CGPoint(x: 2.31, y: 101.38))
        bezier6Path.addCurve(to: CGPoint(x: 16.99, y: 84.35), controlPoint1: CGPoint(x: 12.26, y: 90.1), controlPoint2: CGPoint(x: 14.43, y: 87.35))
        paoTextWhite.setFill()
        bezier6Path.fill()
    ...
    @objc public dynamic class func drawPaoButtonConfig(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 66, height: 90), resizing: ResizingBehavior = .aspectFit, isPressed: Bool = false) {
        ...
        //// Bezier 4 Drawing
        let bezier4Path = UIBezierPath()
        bezier4Path.move(to: CGPoint(x: 50.77, y: 41.28))
        bezier4Path.addCurve(to: CGPoint(x: 49.94, y: 41.08), controlPoint1: CGPoint(x: 50.57, y: 41.04), controlPoint2: CGPoint(x: 50.23, y: 40.96))
        bezier4Path.addCurve(to: CGPoint(x: 43.12, y: 42.41), controlPoint1: CGPoint(x: 47.77, y: 41.96), controlPoint2: CGPoint(x: 45.47, y: 42.41))
        bezier4Path.addCurve(to: CGPoint(x: 25.14, y: 24.61), controlPoint1: CGPoint(x: 33.2, y: 42.41), controlPoint2: CGPoint(x: 25.14, y: 34.42))
        bezier4Path.addCurve(to: CGPoint(x: 27.99, y: 14.99), controlPoint1: CGPoint(x: 25.14, y: 21.19), controlPoint2: CGPoint(x: 26.12, y: 17.86))
        bezier4Path.addCurve(to: CGPoint(x: 27.94, y: 14.15), controlPoint1: CGPoint(x: 28.16, y: 14.73), controlPoint2: CGPoint(x: 28.14, y: 14.39))
        bezier4Path.addCurve(to: CGPoint(x: 27.12, y: 13.95), controlPoint1: CGPoint(x: 27.74, y: 13.91), controlPoint2: CGPoint(x: 27.41, y: 13.83))
        bezier4Path.addCurve(to: CGPoint(x: 15.07, y: 31.73), controlPoint1: CGPoint(x: 19.8, y: 16.92), controlPoint2: CGPoint(x: 15.07, y: 23.9))
        bezier4Path.addCurve(to: CGPoint(x: 34.49, y: 50.95), controlPoint1: CGPoint(x: 15.07, y: 42.33), controlPoint2: CGPoint(x: 23.78, y: 50.95))
        bezier4Path.addCurve(to: CGPoint(x: 50.82, y: 42.12), controlPoint1: CGPoint(x: 41.12, y: 50.95), controlPoint2: CGPoint(x: 47.22, y: 47.65))
        bezier4Path.addCurve(to: CGPoint(x: 50.77, y: 41.28), controlPoint1: CGPoint(x: 50.99, y: 41.86), controlPoint2: CGPoint(x: 50.97, y: 41.52))
        bezier4Path.close()
        paoTextWhite.setFill()
        bezier4Path.fill()
        ...
        //// Bezier 5 Drawing
        let bezier5Path = UIBezierPath()
        bezier5Path.move(to: CGPoint(x: 31.61, y: 18.2))
        bezier5Path.addLine(to: CGPoint(x: 34.49, y: 18.2))
        bezier5Path.addLine(to: CGPoint(x: 31.03, y: 22.76))
        bezier5Path.addCurve(to: CGPoint(x: 30.97, y: 23.5), controlPoint1: CGPoint(x: 30.87, y: 22.97), controlPoint2: CGPoint(x: 30.84, y: 23.26))
        bezier5Path.addCurve(to: CGPoint(x: 31.61, y: 23.9), controlPoint1: CGPoint(x: 31.09, y: 23.75), controlPoint2: CGPoint(x: 31.34, y: 23.9))
        bezier5Path.addLine(to: CGPoint(x: 35.92, y: 23.9))
        bezier5Path.addCurve(to: CGPoint(x: 36.64, y: 23.19), controlPoint1: CGPoint(x: 36.32, y: 23.9), controlPoint2: CGPoint(x: 36.64, y: 23.58))
        bezier5Path.addCurve(to: CGPoint(x: 35.92, y: 22.47), controlPoint1: CGPoint(x: 36.64, y: 22.79), controlPoint2: CGPoint(x: 36.32, y: 22.47))
        bezier5Path.addLine(to: CGPoint(x: 33.05, y: 22.47))
        bezier5Path.addLine(to: CGPoint(x: 36.5, y: 17.92))
        bezier5Path.addCurve(to: CGPoint(x: 36.57, y: 17.17), controlPoint1: CGPoint(x: 36.66, y: 17.7), controlPoint2: CGPoint(x: 36.69, y: 17.41))
        bezier5Path.addCurve(to: CGPoint(x: 35.92, y: 16.78), controlPoint1: CGPoint(x: 36.45, y: 16.93), controlPoint2: CGPoint(x: 36.2, y: 16.78))
        bezier5Path.addLine(to: CGPoint(x: 31.61, y: 16.78))
        bezier5Path.addCurve(to: CGPoint(x: 30.89, y: 17.49), controlPoint1: CGPoint(x: 31.21, y: 16.78), controlPoint2: CGPoint(x: 30.89, y: 17.1))
        bezier5Path.addCurve(to: CGPoint(x: 31.61, y: 18.2), controlPoint1: CGPoint(x: 30.89, y: 17.88), controlPoint2: CGPoint(x: 31.21, y: 18.2))
        bezier5Path.close()
        paoTextWhite.setFill()
        bezier5Path.fill()
        ...
        //// Bezier 6 Drawing
        let bezier6Path = UIBezierPath()
        bezier6Path.move(to: CGPoint(x: 38.8, y: 22.47))
        bezier6Path.addLine(to: CGPoint(x: 40.34, y: 22.47))
        bezier6Path.addLine(to: CGPoint(x: 38.2, y: 25.64))
        bezier6Path.addCurve(to: CGPoint(x: 38.17, y: 26.37), controlPoint1: CGPoint(x: 38.06, y: 25.86), controlPoint2: CGPoint(x: 38.04, y: 26.14))
        bezier6Path.addCurve(to: CGPoint(x: 38.8, y: 26.75), controlPoint1: CGPoint(x: 38.29, y: 26.6), controlPoint2: CGPoint(x: 38.54, y: 26.75))
        bezier6Path.addLine(to: CGPoint(x: 41.68, y: 26.75))
        bezier6Path.addCurve(to: CGPoint(x: 42.4, y: 26.03), controlPoint1: CGPoint(x: 42.08, y: 26.75), controlPoint2: CGPoint(x: 42.4, y: 26.43))
        bezier6Path.addCurve(to: CGPoint(x: 41.68, y: 25.32), controlPoint1: CGPoint(x: 42.4, y: 25.64), controlPoint2: CGPoint(x: 42.08, y: 25.32))
        bezier6Path.addLine(to: CGPoint(x: 40.15, y: 25.32))
        bezier6Path.addLine(to: CGPoint(x: 42.28, y: 22.16))
        bezier6Path.addCurve(to: CGPoint(x: 42.31, y: 21.43), controlPoint1: CGPoint(x: 42.42, y: 21.94), controlPoint2: CGPoint(x: 42.44, y: 21.66))
        bezier6Path.addCurve(to: CGPoint(x: 41.68, y: 21.05), controlPoint1: CGPoint(x: 42.19, y: 21.2), controlPoint2: CGPoint(x: 41.94, y: 21.05))
        bezier6Path.addLine(to: CGPoint(x: 38.8, y: 21.05))
        bezier6Path.addCurve(to: CGPoint(x: 38.08, y: 21.76), controlPoint1: CGPoint(x: 38.4, y: 21.05), controlPoint2: CGPoint(x: 38.08, y: 21.37))
        bezier6Path.addCurve(to: CGPoint(x: 38.8, y: 22.47), controlPoint1: CGPoint(x: 38.08, y: 22.16), controlPoint2: CGPoint(x: 38.4, y: 22.47))
        bezier6Path.close()
        paoTextWhite.setFill()
        bezier6Path.fill()
        ...
        //// Bezier 7 Drawing
        let bezier7Path = UIBezierPath()
        bezier7Path.move(to: CGPoint(x: 33.87, y: 30.68))
        bezier7Path.addCurve(to: CGPoint(x: 34.49, y: 31.02), controlPoint1: CGPoint(x: 34.01, y: 30.89), controlPoint2: CGPoint(x: 34.24, y: 31.02))
        bezier7Path.addLine(to: CGPoint(x: 35.92, y: 31.02))
        bezier7Path.addCurve(to: CGPoint(x: 36.64, y: 30.3), controlPoint1: CGPoint(x: 36.32, y: 31.02), controlPoint2: CGPoint(x: 36.64, y: 30.7))
        bezier7Path.addCurve(to: CGPoint(x: 35.92, y: 29.59), controlPoint1: CGPoint(x: 36.64, y: 29.91), controlPoint2: CGPoint(x: 36.32, y: 29.59))
        bezier7Path.addLine(to: CGPoint(x: 35.65, y: 29.59))
        bezier7Path.addLine(to: CGPoint(x: 36.57, y: 27.78))
        bezier7Path.addCurve(to: CGPoint(x: 36.54, y: 27.08), controlPoint1: CGPoint(x: 36.68, y: 27.55), controlPoint2: CGPoint(x: 36.67, y: 27.29))
        bezier7Path.addCurve(to: CGPoint(x: 35.92, y: 26.75), controlPoint1: CGPoint(x: 36.41, y: 26.87), controlPoint2: CGPoint(x: 36.17, y: 26.75))
        bezier7Path.addLine(to: CGPoint(x: 34.49, y: 26.75))
        bezier7Path.addCurve(to: CGPoint(x: 33.77, y: 27.46), controlPoint1: CGPoint(x: 34.09, y: 26.75), controlPoint2: CGPoint(x: 33.77, y: 27.06))
        bezier7Path.addCurve(to: CGPoint(x: 34.49, y: 28.17), controlPoint1: CGPoint(x: 33.77, y: 27.85), controlPoint2: CGPoint(x: 34.09, y: 28.17))
        bezier7Path.addLine(to: CGPoint(x: 34.76, y: 28.17))
        bezier7Path.addLine(to: CGPoint(x: 33.84, y: 29.99))
        bezier7Path.addCurve(to: CGPoint(x: 33.87, y: 30.68), controlPoint1: CGPoint(x: 33.73, y: 30.21), controlPoint2: CGPoint(x: 33.74, y: 30.47))
        bezier7Path.close()
        paoTextWhite.setFill()
        bezier7Path.fill()
    ...
    @objc public dynamic class func drawPaoButtonHelp(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 66, height: 90), resizing: ResizingBehavior = .aspectFit, isPressed: Bool = false) {
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 15.01, y: 25.68))
        bezier2Path.addLine(to: CGPoint(x: 21.63, y: 25.67))
        bezier2Path.addCurve(to: CGPoint(x: 25.5, y: 28.67), controlPoint1: CGPoint(x: 22.11, y: 27.4), controlPoint2: CGPoint(x: 23.66, y: 28.67))
        bezier2Path.addCurve(to: CGPoint(x: 29.37, y: 25.67), controlPoint1: CGPoint(x: 27.33, y: 28.67), controlPoint2: CGPoint(x: 28.88, y: 27.4))
        bezier2Path.addLine(to: CGPoint(x: 50.99, y: 25.67))
        bezier2Path.addCurve(to: CGPoint(x: 52.1, y: 24.53), controlPoint1: CGPoint(x: 51.6, y: 25.67), controlPoint2: CGPoint(x: 52.1, y: 25.16))
        bezier2Path.addCurve(to: CGPoint(x: 50.99, y: 23.38), controlPoint1: CGPoint(x: 52.1, y: 23.9), controlPoint2: CGPoint(x: 51.6, y: 23.38))
        bezier2Path.addLine(to: CGPoint(x: 29.37, y: 23.39))
        bezier2Path.addCurve(to: CGPoint(x: 25.5, y: 20.38), controlPoint1: CGPoint(x: 28.89, y: 21.66), controlPoint2: CGPoint(x: 27.33, y: 20.38))
        bezier2Path.addCurve(to: CGPoint(x: 21.62, y: 23.39), controlPoint1: CGPoint(x: 23.66, y: 20.38), controlPoint2: CGPoint(x: 22.1, y: 21.66))
        bezier2Path.addLine(to: CGPoint(x: 15.01, y: 23.39))
        bezier2Path.addCurve(to: CGPoint(x: 13.9, y: 24.53), controlPoint1: CGPoint(x: 14.4, y: 23.39), controlPoint2: CGPoint(x: 13.9, y: 23.9))
        bezier2Path.addCurve(to: CGPoint(x: 15.01, y: 25.68), controlPoint1: CGPoint(x: 13.9, y: 25.16), controlPoint2: CGPoint(x: 14.4, y: 25.68))
        bezier2Path.close()
        paoTextWhite.setFill()
        bezier2Path.fill()
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 50.99, y: 34.53))
        bezier3Path.addLine(to: CGPoint(x: 44.68, y: 34.53))
        bezier3Path.addCurve(to: CGPoint(x: 40.81, y: 31.52), controlPoint1: CGPoint(x: 44.19, y: 32.8), controlPoint2: CGPoint(x: 42.64, y: 31.52))
        bezier3Path.addCurve(to: CGPoint(x: 36.94, y: 34.53), controlPoint1: CGPoint(x: 38.97, y: 31.52), controlPoint2: CGPoint(x: 37.42, y: 32.79))
        bezier3Path.addLine(to: CGPoint(x: 15.02, y: 34.53))
        bezier3Path.addCurve(to: CGPoint(x: 13.91, y: 35.67), controlPoint1: CGPoint(x: 14.4, y: 34.53), controlPoint2: CGPoint(x: 13.91, y: 35.04))
        bezier3Path.addCurve(to: CGPoint(x: 15.02, y: 36.81), controlPoint1: CGPoint(x: 13.91, y: 36.3), controlPoint2: CGPoint(x: 14.4, y: 36.81))
        bezier3Path.addLine(to: CGPoint(x: 36.94, y: 36.81))
        bezier3Path.addCurve(to: CGPoint(x: 40.81, y: 39.81), controlPoint1: CGPoint(x: 37.42, y: 38.54), controlPoint2: CGPoint(x: 38.97, y: 39.81))
        bezier3Path.addCurve(to: CGPoint(x: 44.68, y: 36.81), controlPoint1: CGPoint(x: 42.64, y: 39.81), controlPoint2: CGPoint(x: 44.19, y: 38.54))
        bezier3Path.addLine(to: CGPoint(x: 50.99, y: 36.81))
        bezier3Path.addCurve(to: CGPoint(x: 52.1, y: 35.67), controlPoint1: CGPoint(x: 51.6, y: 36.81), controlPoint2: CGPoint(x: 52.1, y: 36.3))
        bezier3Path.addCurve(to: CGPoint(x: 50.99, y: 34.53), controlPoint1: CGPoint(x: 52.1, y: 35.04), controlPoint2: CGPoint(x: 51.6, y: 34.53))
        bezier3Path.close()
        paoTextWhite.setFill()
        bezier3Path.fill()
        ...
        //// Bezier 4 Drawing
        let bezier4Path = UIBezierPath()
        bezier4Path.move(to: CGPoint(x: 50.99, y: 45.12))
        bezier4Path.addLine(to: CGPoint(x: 35.77, y: 45.12))
        bezier4Path.addCurve(to: CGPoint(x: 31.89, y: 42.12), controlPoint1: CGPoint(x: 35.28, y: 43.39), controlPoint2: CGPoint(x: 33.73, y: 42.12))
        bezier4Path.addCurve(to: CGPoint(x: 28.02, y: 45.12), controlPoint1: CGPoint(x: 30.06, y: 42.12), controlPoint2: CGPoint(x: 28.51, y: 43.39))
        bezier4Path.addLine(to: CGPoint(x: 15.02, y: 45.12))
        bezier4Path.addCurve(to: CGPoint(x: 13.91, y: 46.27), controlPoint1: CGPoint(x: 14.4, y: 45.12), controlPoint2: CGPoint(x: 13.91, y: 45.64))
        bezier4Path.addCurve(to: CGPoint(x: 15.02, y: 47.41), controlPoint1: CGPoint(x: 13.91, y: 46.9), controlPoint2: CGPoint(x: 14.4, y: 47.41))
        bezier4Path.addLine(to: CGPoint(x: 28.02, y: 47.41))
        bezier4Path.addCurve(to: CGPoint(x: 31.89, y: 50.41), controlPoint1: CGPoint(x: 28.51, y: 49.14), controlPoint2: CGPoint(x: 30.06, y: 50.41))
        bezier4Path.addCurve(to: CGPoint(x: 35.76, y: 47.41), controlPoint1: CGPoint(x: 33.73, y: 50.41), controlPoint2: CGPoint(x: 35.28, y: 49.14))
        bezier4Path.addLine(to: CGPoint(x: 50.99, y: 47.41))
        bezier4Path.addCurve(to: CGPoint(x: 52.1, y: 46.26), controlPoint1: CGPoint(x: 51.6, y: 47.41), controlPoint2: CGPoint(x: 52.1, y: 46.9))
        bezier4Path.addCurve(to: CGPoint(x: 50.99, y: 45.12), controlPoint1: CGPoint(x: 52.1, y: 45.63), controlPoint2: CGPoint(x: 51.6, y: 45.12))
        bezier4Path.close()
        paoTextWhite.setFill()
        bezier4Path.fill()
