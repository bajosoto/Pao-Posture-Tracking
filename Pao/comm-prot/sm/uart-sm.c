...
/* sendAck()
 * Author: 		Sergio Soto
 * Function: 	Acknowledge last message received
...
void sendChar(uint8_t c) {
		...
		rs232_putchar(c);
	#elif defined BUILD_ES
		printf("%c", c);						// TODO: Replace printf for performance
		fflush(stdout);							// I'm flushing stdout since printf won't unless it finds a '\n'
	#endif
}
